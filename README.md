...
EMverse is an experimental full-stack emotion-sharing wall. Visitors can post a short message, associate it with one of six emotions, and explore the visible messages through an animated React interface.
